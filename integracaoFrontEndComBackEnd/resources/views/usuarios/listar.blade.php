...
<html
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="col-md-">
                  <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card">
                <h5 class="card-header">Listagem de Níveis de Acesso</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $usuario->nome }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $usuario->data_nascimento }}</strong></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $usuario->telefone }}</strong></td>
                        <td>
                            <span class="badge bg-label-success me-1">{{ $usuario->created_at }}</span>
                        </td>
                        <td><span class="badge bg-label-primary me-1">{{ $usuario->updated_at }}</span></td>
                        <td><span class="badge bg-label-primary me-1">{{ $usuario->nivelAcesso->nivel_acesso }}</span></td>
                        <td>{{ $usuario->cpf }}</td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              {{-- Botão para tela de atualizar --}}
                              <a class="dropdown-item" href="{{ route('usuarios.atualizar', $usuario->id) }}"
                                ><i class="bx bx-edit-alt me-1"></i> Editar</a
                              >
                              {{-- Formulário para exclusão --}}
                              <form method="POST" action="{{ route('usuarios.deletar', $usuario->id) }}">
                                @csrf
                                @method('DELETE')
    ...
    <scrip async defer src="https://buttons.github.io/buttons.js"></script>

    {{-- Importação Sweet Alert --}}
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <script>
      function exibirSweetAlert(icone, titulo, texto) {
        Swal.fire({
          title: titulo,
          text: texto,
          icon: icone
    ...
    @if(@session('success'))
      <script>exibirSweetAlert('success', 'Sucesso!, {{ session('success') }}')</script>
    @endif

    @if ($errors->any())
        <script>exibirSweetAlert('error', 'Erro!', '{{ implode('|', $errors->all()) }}')</script>
    @endif
  </body>
</html>
