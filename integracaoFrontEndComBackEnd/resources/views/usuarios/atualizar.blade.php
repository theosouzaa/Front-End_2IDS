        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="col-md-">
                  <div class="card">
                    <h5 class="card-header text-center">Atualizar de Usuários 👨🏼‍👩🏼‍👧🏼‍👦🏼</h5>
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            class="form-control"
                            id="dataNascimento"
                            value="{{ old('data_nascimento', $usuarios->data_nascimento) }}"
                            name="dataNascimento"/>
                        </div>
                        {{-- Campo telefone --}}
                        <div class="col-md-4">
                            ...
                            id="telefone"
                            name="telefone"
                            value="{{ old('telefone', $usuarios->telefone) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="nivelAcessoId" name="nivelAcessoId"
                            aria-label="Default select example">
                            @foreach ($nivelAcesso as $nivel)
                                <option value="{{ $nivel->id }}" {{ $usuarios->nivel_acesso_id == $nivel->id ? 'selected' : '' }}>
                                    {{ $nivel->id }}>{{ $nivel->nivel_acesso }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary col-md-12 mt-4">Atializar</button>
                </form> 
                </div>
                  </div>
                </div>
